...
/* Creates a Nigiri object that is an instance of Sushi. Uses enumeration and switch cases to create variations of the 
 * Nigiri object. Override methods are used to set new values to methods originally outlined in the parent interface.
 */

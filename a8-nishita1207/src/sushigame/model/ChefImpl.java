...
public class ChefImpl implements Chef, BeltObserver {
	...
	private int total_food_consumed = 0;
	private int total_spoiled_food = 0;
	...
	// Returns the amount of total food consumed by customers
	@Override
